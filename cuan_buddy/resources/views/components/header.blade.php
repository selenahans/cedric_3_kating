        ...
        <div class="profile-dropdown-wrapper">
            <button class="profile-trigger">
                <div class="avatar-container">
                    <img src="https://ui-avatars.com/api/?name=Selena+Gomez&background=308156&color=fff" alt="User" class="avatar-img">
                </div>
                <div class="user-info">
                    <p class="user-name">Selena</p>
            ...
            <div class="dropdown-menu">
                <div class="dropdown-header">
                    ...
                    <p class="signed-in-email">selena@gmail.com</p>
                </div>
