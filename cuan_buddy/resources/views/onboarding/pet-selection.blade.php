...
<head>
    ...
    <style>
        ...
        .input-field {
            ...
            background-color: #F8FAFC; /* Putih transparan */
            text-align: center;
            font-weight: 600;
        ...
        .pet-card {
            ...
            position: relative;
            overflow: hidden;
            background-color: rgba(255, 255, 255, 0.6); /* Semi transparan agar bg noise terlihat dikit */
...
<body class="text-slate-900 font-jakarta overflow-x-hidden relative min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-5xl px-6 py-8 relative z-10 animate-fade-in-up">
        ...
        <a href="{{ url('/') }}" class="inline-flex items-center gap-2 text-slate-500 hover:text-[#308156] transition mb-6 font-semibold group">
            <div class="w-10 h-10 rounded-full bg-white/60 border border-slate-200 flex items-center justify-center group-hover:border-[#308156] group-hover:bg-white transition shadow-sm backdrop-blur-sm">
        ...
        <div class="bg-white/70 backdrop-blur-xl border border-white/60 shadow-2xl rounded-[2rem] p-6 lg:p-12">
            ...
            <form action="#" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-12">
                    ...
                    <div class="pet-card border-2 border-slate-200 rounded-2xl p-6 flex flex-col items-center group" onclick="selectPet(this, 'cat')">
                        <div class="absolute top-3 right-3 opacity-0 check-icon transition-opacity duration-300">
                            <div class="w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center text-white shadow-md">
                        ...
                        <div class="w-32 h-32 mb-4 drop-shadow-lg">
                            <img src="https://cdni.iconscout.com/illustration/premium/thumb/cat-sitting-in-box-illustration-download-in-svg-png-gif-file-formats--kitty-kitten-animal-pet-pack-animals-illustrations-4753046.png" alt="Kucing Pintar" class="w-full h-full object-contain animate-float">
                        </div>
                    ...
                    <div class="pet-card border-2 border-slate-200 rounded-2xl p-6 flex flex-col items-center group" onclick="selectPet(this, 'dog')">
                        <div class="absolute top-3 right-3 opacity-0 check-icon transition-opacity duration-300">
                            <div class="w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center text-white shadow-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" /></svg>
                            </div>
                        ...
                        <div class="w-32 h-32 mb-4 drop-shadow-lg">
                            <img src="https://cdni.iconscout.com/illustration/premium/thumb/dog-bone-illustration-download-in-svg-png-gif-file-formats--animal-food-pet-puppy-pack-nature-illustrations-4753066.png" alt="Anjing Setia" class="w-full h-full object-contain animate-float" style="animation-delay: 1s;">
                        </div>
                    ...
                    <div class="pet-card border-2 border-slate-200 rounded-2xl p-6 flex flex-col items-center group" onclick="selectPet(this, 'rabbit')">
                        <div class="absolute top-3 right-3 opacity-0 check-icon transition-opacity duration-300">
                            <div class="w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center text-white shadow-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" /></svg>
                            </div>
                        ...
                        <div class="w-32 h-32 mb-4 drop-shadow-lg">
                            <img src="https://cdni.iconscout.com/illustration/premium/thumb/rabbit-holding-carrot-illustration-download-in-svg-png-gif-file-formats--bunny-animal-pet-food-nature-pack-illustrations-4753049.png" alt="Kelinci Cepat" class="w-full h-full object-contain animate-float" style="animation-delay: 2s;">
                        </div>
                    ...
                    <div class="pet-card border-2 border-slate-200 rounded-2xl p-6 flex flex-col items-center group" onclick="selectPet(this, 'bear')">
                        <div class="absolute top-3 right-3 opacity-0 check-icon transition-opacity duration-300">
                            <div class="w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center text-white shadow-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" /></svg>
                            </div>
                        ...
                        <div class="w-32 h-32 mb-4 drop-shadow-lg">
                            <img src="https://cdni.iconscout.com/illustration/premium/thumb/teddy-bear-illustration-download-in-svg-png-gif-file-formats--toy-stuffed-animal-love-romance-pack-holidays-illustrations-4753063.png" alt="Beruang Santai" class="w-full h-full object-contain animate-float" style="animation-delay: 3s;">
                        </div>
                ...
                <div class="max-w-md mx-auto">
                    <label for="pet_name" class="block text-sm font-semibold text-slate-700 mb-3 text-center uppercase tracking-wide">Beri Nama Partner Barumu</label>
