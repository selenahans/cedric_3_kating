...
@section('content')
    <div x-data="{ 
        ...
        {{-- 1. PAGE HEADER & ACTIONS (Updated Layout) --}}
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 relative z-10">
            ...
            <div class="flex items-center gap-2 sm:gap-4 transition-all duration-300 ease-in-out">
                ...
                {{-- 🐱 PET COMPANION (Dynamic Pill Concept) --}}
                {{-- x-data untuk kontrol hover --}}
                <div x-data="{ hovered: false }" @mouseenter="hovered = true" @mouseleave="hovered = false"
                    ...
                    {{-- Pesan (Hidden by default, expands on hover) --}}
                ...
                {{-- TEXT JUDUL (Akan terdorong ke kanan saat pet melebar) --}}
        ...
        {{-- 3. TABS SWITCHER --}}
        <div class="bg-white p-1.5 rounded-2xl inline-flex mb-6 border border-slate-200 shadow-sm">
        ...
        {{-- 5. MODAL (Sama seperti sebelumnya) --}}
                ...
                <div
                    ...
                    <div class="bg-white px-6 py-4 border-b border-slate-100 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-slate-800"
                            x-text="modalType === 'create' ? 'Tambah Transaksi Baru' : 'Edit Transaksi'"></h3>
                    ...
                    <div class="px-6 py-6 space-y-4">
                        {{-- Form Fields (Bisa dicopy dari kode sebelumnya jika dibutuhkan) --}}
                        <div>
